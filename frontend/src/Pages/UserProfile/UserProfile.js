...
function UserProfile() {
  ...
  const sendFileForVerification = async (e) => {
    console.log("Sending file for verification:", selectedFile);
    try {
      const response = await fetch(
      ...
      if (response.status === 200) {
        ...
        showErrorAlert(errorData.error || "Failed to update isVerified status");
      }
    } catch (error) {
      console.error(error);
      ...
      return (
        <div className="card mb-4">
          <div className="card-body">
            ...
            <Form onSubmit={sendFileForVerification}>
              ...
              <Button
                ...
                type="submit"
                // onClick={sendFileForVerification}
              >
                Submit Verification
              </Button>
            </Form>
